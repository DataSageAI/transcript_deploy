...
# Inicializa a variável 'client' como None
client = None

# Adiciona um campo para o usuário inserir a chave API
api_key = st.text_input('Por favor, insira sua chave API da OpenAI:', type='password')
